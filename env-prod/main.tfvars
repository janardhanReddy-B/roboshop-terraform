...
apps = {
  ...
  catalogue = {
    ...
    extra_param_access = ["arn:aws:ssm:us-east-1:637261222008:parameter/roboshop.prod.docdb.*"]
  }
  user = {
    component          = "user"
    app_port           = 8080
  ...
  shipping = {
    ...
    extra_param_access = ["arn:aws:ssm:us-east-1:637261222008:parameter/roboshop.prod.mysql.*"]
  }
  payment = {
    component        = "payment"
    app_port         = 8080
